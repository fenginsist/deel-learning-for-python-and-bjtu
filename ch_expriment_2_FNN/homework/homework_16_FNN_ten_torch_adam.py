...
adam_optimizer = torch.optim.Adam(model.parameters(), lr=0.01, betas=(0.9, 0.999), eps=1e-6)
print('model:', model)
train_all_loss, test_all_loss, train_ACC, test_ACC = train_and_test_torch(model=model, epochs=20, optimizer=adam_optimizer)
