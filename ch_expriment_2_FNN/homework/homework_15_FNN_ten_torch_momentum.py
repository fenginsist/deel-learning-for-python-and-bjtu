...
SGD_momentum_optimizer = torch.optim.SGD(model.parameters(), lr=0.01, momentum=0.5)
print('model:', model)
train_all_loss, test_all_loss, train_ACC, test_ACC = train_and_test_torch(model=model, epochs=20, optimizer=SGD_momentum_optimizer)
